<?php
	...
	*/
	...
	function mv_130_report_constructor($mv_report_result){
...
/* БАЛАНС */
		...
		*/
		...
		echo'<table class="mv_130_report_table">';
		echo'<tbody>';
		...
		echo'<tbody>';
		/* Шапка таблицы позиций */
		echo'<tr class="mv_130_datatable_header" >';
		...
		echo'<tr class="mv_130_rt_border_top" >';
		...
		/* /Цикл  вывода позиций  */
		/* строка итогов */
		echo'<tr class="mv_130_datatable_total" >';
