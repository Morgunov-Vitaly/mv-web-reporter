	...
	*/
	...
	function mv_150_report_constructor($mv_report_result){
		...
		*/		
		...
		$mv_report150_head_mobile = ' vc_col-sm-5  vc_col-xs-12 wpb_column vc_column_container" ><p class ="mv_orgname">' . $mv_report_result->employeeSummary[0]->divisionName . '</p></div>
