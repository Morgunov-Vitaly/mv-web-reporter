	...
	*/
	...
	function mv_150_report_constructor($mv_report_result){
		...
		*/		
		...
		<div class="report_header  vc_col-sm-2 vc_col-xs-3 wpb_column vc_column_container" ><p class="mv_header_img"><img class="mv_75_img" src="' . plugin_dir_url( __FILE__ ) . '../img/receipt.svg"><br>' .__('Чеков', 'mv-web-reporter') . '</p></div>
		...
		<div class="report_header  vc_col-sm-2 vc_col-xs-3 wpb_column vc_column_container" ><p class="mv_header_img"><img class="mv_75_img" src="' . plugin_dir_url( __FILE__ ) . '../img/receipt.svg"><br>' .__('Чеков', 'mv-web-reporter') . '</p>
		</div>
		<div class="report_header  vc_col-sm-1 vc_col-xs-2 wpb_column vc_column_container" ><p class="mv_header_img"><img class="mv_75_img" src="' . plugin_dir_url( __FILE__ ) . '../img/rate.svg"><br>' .__('Рейтинг', 'mv-web-reporter') . '</p>
		</div>		
		</div>';
...
<div class="report_footer  vc_col-sm-2 vc_col-xs-3 wpb_column vc_column_container" >'. number_format(($mv_total_invoices_qty), 0, ',', ' ') . '</div>
<div class="report_footer  vc_col-sm-1 vc_col-xs-2 wpb_column vc_column_container" >-</div>
</div>';		
